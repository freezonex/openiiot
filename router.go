...
func customizeRegister(r *server.Hertz, c *config.Config) {
	...
	wmsInboundRecordGroup := r.Group("/wms/inboundrecord", middleware.Access())
	{
	...
	wms_Stocktaking_recordGroup := r.Group("/wms/stocktaking/record", middleware.Access())
	{
