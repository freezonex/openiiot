...
def PR_BODY = 'Auto-generated files for the pb_idl submodule based on the latest changes. Please review and merge if everything looks good.'
                    ...
                    if (CHANGE_LIST_ID != '') {
                        ...
                        withCredentials([string(credentialsId: 'hongzhi_token', variable: 'GITHUB_TOKEN')]) {
                            dir('openiiot') {
                                ...
                                // Create the pull request and capture the response
