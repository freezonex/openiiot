...
func newApp(db *gorm.DB, opts ...gen.DOOption) app {
	...
	_app.appDo.UseModel(&model_openiiot.App{})
	...
	_app.TenantID = field.NewInt64(tableName, "tenant_id")
	_app.URL = field.NewString(tableName, "url")
	_app.Username = field.NewString(tableName, "username")
	_app.Password = field.NewString(tableName, "password")
	_app.Type = field.NewString(tableName, "type")
	_app.Source = field.NewString(tableName, "source")
...
func (a appDo) Create(values ...*model_openiiot.App) error {
	if len(values) == 0 {
		return nil
	}
...
func (a appDo) CreateInBatches(values []*model_openiiot.App, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a appDo) Save(values ...*model_openiiot.App) error {
	if len(values) == 0 {
		return nil
	}
...
func (a appDo) First() (*model_openiiot.App, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model_openiiot.App), nil
	}
}

func (a appDo) Take() (*model_openiiot.App, error) {
...
func (a appDo) Last() (*model_openiiot.App, error) {
...
func (a appDo) Find() ([]*model_openiiot.App, error) {
	result, err := a.DO.Find()
	return result.([]*model_openiiot.App), err
}

func (a appDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model_openiiot.App, err error) {
	buf := make([]*model_openiiot.App, 0, batchSize)
...
func (a appDo) FindInBatches(result *[]*model_openiiot.App, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a appDo) FirstOrInit() (*model_openiiot.App, error) {
...
func (a appDo) FirstOrCreate() (*model_openiiot.App, error) {
...
func (a appDo) FindByPage(offset int, limit int) (result []*model_openiiot.App, count int64, err error) {
...
func (a appDo) Delete(models ...*model_openiiot.App) (result gen.ResultInfo, err error) {
