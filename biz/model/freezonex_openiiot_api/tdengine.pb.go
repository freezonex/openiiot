...
type TDEngineExecResponse struct {
	...
	BaseResp     *base_resp.BaseResponse `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp" form:"base_resp" query:"base_resp"`
	RowsAffected int64                   `protobuf:"varint,3,opt,name=rows_affected,json=rowsAffected,proto3" json:"rows_affected" form:"rows_affected" query:"rows_affected"`
}
...
type TDEngineQueryResponse struct {
	...
	BaseResp *base_resp.BaseResponse `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp" form:"base_resp" query:"base_resp"`
	Data     []*TDEngineRow          `protobuf:"bytes,5,rep,name=data,proto3" json:"data" form:"data" query:"data"`
}
...
func (x *TDEngineQueryResponse) GetData() []*TDEngineRow {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_freezonex_openiiot_api_tdengine_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x66, 0x72, 0x65, 0x65,
	0x7a, 0x6f, 0x6e, 0x65, 0x78, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x69, 0x69, 0x6f, 0x74, 0x5f, 0x61,
	0x70, 0x69, 0x2e, 0x54, 0x44, 0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x52, 0x6f, 0x77, 0x52, 0x04,
...
var file_freezonex_openiiot_api_tdengine_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_freezonex_openiiot_api_tdengine_proto_goTypes = []interface{}{
	...
	(*TDEngineQueryRequest)(nil),           // 6: freezonex.openiiot_api.TDEngineQueryRequest
	(*TDEngineQueryResponse)(nil),          // 7: freezonex.openiiot_api.TDEngineQueryResponse
...
var file_freezonex_openiiot_api_tdengine_proto_depIdxs = []int32{
	8,  // 0: freezonex.openiiot_api.TDEngineTestConnectionRequest.base_request:type_name -> base_req.BaseRequest
	0,  // 1: freezonex.openiiot_api.TDEngineTestConnectionRequest.dsn:type_name -> freezonex.openiiot_api.TDEngineDSN
	9,  // 2: freezonex.openiiot_api.TDEngineTestConnectionResponse.base_resp:type_name -> base_resp.BaseResponse
	8,  // 3: freezonex.openiiot_api.TDEngineExecRequest.base_request:type_name -> base_req.BaseRequest
	0,  // 4: freezonex.openiiot_api.TDEngineExecRequest.dsn:type_name -> freezonex.openiiot_api.TDEngineDSN
	9,  // 5: freezonex.openiiot_api.TDEngineExecResponse.base_resp:type_name -> base_resp.BaseResponse
	8,  // 6: freezonex.openiiot_api.TDEngineQueryRequest.base_request:type_name -> base_req.BaseRequest
	0,  // 7: freezonex.openiiot_api.TDEngineQueryRequest.dsn:type_name -> freezonex.openiiot_api.TDEngineDSN
	9,  // 8: freezonex.openiiot_api.TDEngineQueryResponse.base_resp:type_name -> base_resp.BaseResponse
	1,  // 9: freezonex.openiiot_api.TDEngineQueryResponse.data:type_name -> freezonex.openiiot_api.TDEngineRow
